...
`adaptNavigationTheme` utility function returning provided React Navigation compliant theme, adapted in terms of colors, to the Material Design 3 color system.
...
Valid `params` keys are:
  ...
  * `lightTheme` () - React Navigation compliant light theme.
  * `darkTheme` () - React Navigation compliant dark theme.
